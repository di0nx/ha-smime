...
DEFAULT_ALLOW_UNENCRYPTED_FALLBACK_DEFAULT = False
DEFAULT_SKIP_RECIPIENTS_WITHOUT_CERT_DEFAULT = False
DEFAULT_LOCAL_SOURCE_ENABLED = True
DEFAULT_REMOTE_SOURCE_ENABLED = False
DEFAULT_REMOTE_ALLOW_INSECURE_HTTP = False
DEFAULT_REMOTE_TIMEOUT = 10
DEFAULT_REMOTE_CACHE_TTL_FALLBACK = 300
DEFAULT_SMIMEA_SOURCE_ENABLED = True
DEFAULT_SMIMEA_SOURCE_ENABLED = False
DEFAULT_SOURCE_ORDER = "local,smimea,remote"

SMTP_ENCRYPTION_NONE = "none"
SMTP_ENCRYPTION_STARTTLS = "starttls"
SMTP_ENCRYPTION_SSL = "ssl"
# Backwards compatibility for config entries created by early versions.
SMTP_ENCRYPTION_SSL_LEGACY = "ssl_tls"
...
# Compatibility aliases used by existing module code and old config entries.
DEFAULT_SIGN = DEFAULT_SIGN_DEFAULT
DEFAULT_ENCRYPT = DEFAULT_ENCRYPT_DEFAULT
DEFAULT_ALLOW_UNENCRYPTED_FALLBACK = DEFAULT_ALLOW_UNENCRYPTED_FALLBACK_DEFAULT
DEFAULT_SKIP_RECIPIENTS_WITHOUT_CERT = DEFAULT_SKIP_RECIPIENTS_WITHOUT_CERT_DEFAULT
